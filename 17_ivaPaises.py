...
def calcularIVA(cantidad):
    ...
    difIva = cantidadConIva - cantidad
    print(f'La cantida a aplicar el iva es: {cantidad}')
    print(f'La cantida a pagar de iva es: {difIva}')
    print(f'La cantida Total a pagar es: {cantidadConIva}')
